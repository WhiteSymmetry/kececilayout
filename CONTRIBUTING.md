...
To report a bug, first make sure there isn't already an open [GitHub Issue](https://github.com/WhiteSymmetry/kececilayout/issues)
...
* The kececilayout version you are using.
* Detailed steps to reproduce the bug.
* A tag, if appropriate (_e.g._, "bug" or "enhancement").

### Fix Open Issues

Look through the [GitHub Issues](https://github.com/WhiteSymmetry/kececilayout/issues) for any
...
Ready to contribute? Here's how to set up kececilayout for local development.
...
2. Create your own fork of the kececilayout [repository](https://github.com/WhiteSymmetry/kececilayout).
3. Clone your repository, for example by typing in your terminal:
`git clone https://github.com/<your_username>/kececilayout.git`.
...
Please note that the kececilayout project is released with a
